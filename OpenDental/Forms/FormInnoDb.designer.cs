namespace OpenDental{
    ...
    "";
			...
			// butToMyIsam
			// 
			this.butToMyIsam.AdjustImageLocation = new System.Drawing.Point(0,0);
			...
			this.butToMyIsam.Autosize = true;
			this.butToMyIsam.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butToMyIsam.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butToMyIsam.CornerRadius = 4F;
			...
			// butToInnoDb
			// 
			this.butToInnoDb.AdjustImageLocation = new System.Drawing.Point(0,0);
			...
			this.butToInnoDb.Autosize = true;
			this.butToInnoDb.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butToInnoDb.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butToInnoDb.CornerRadius = 4F;
