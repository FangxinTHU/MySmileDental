		...
		private void SetValuesUsingFieldId_v2(string pFieldId){
			switch(pFieldId)
			{
				...
				case "D03":
					...
					frenchFieldName="Le prénom de l'abonn?";
					format="A";
					lengthRequirement=new ConstLengthRequirement(15);
					break;
				case "D04":
				...
				case "D08":
					...
					frenchFieldName="Code de la province/état de l'abonn?";
					format="A";
					lengthRequirement=new ConstLengthRequirement(2);
				...
				case "F07":
					...
					frenchFieldName="Ligne nombre de procéd?";
					format="N";
					lengthRequirement=new ConstLengthRequirement(1);
				...
				case "F08":
					...
					frenchFieldName="Code de procéd?";
					format="N";
				...
				case "F13":
					...
					frenchFieldName="Honoraires # 1 de procéd?de laboratoire";
					format="D";
					lengthRequirement=new ConstLengthRequirement(6);
					break;
				case "F14":
				...
				case "G10":
					...
					frenchFieldName="Le nombre de porteur a publi?des codes de procéd?";
					format="N";
					lengthRequirement=new ConstLengthRequirement(1);
				...
				case "G12":
					...
					frenchFieldName="Quantit?éligible";
					format="D";
					lengthRequirement=new ConstLengthRequirement(6);
					break;
				case "G13":
					fieldName="Deductible Amount";
					frenchFieldName="Quantit?déductible";
					format="D";
					lengthRequirement=new ConstLengthRequirement(5);
					break;
				case "G14":
				...
				case "G15":
					...
					frenchFieldName="Quantit?d'avantage pour le procéd?";
					format="D";
					lengthRequirement=new ConstLengthRequirement(6);
					break;
				case "G16":
				...
				case "G18":
					...
					frenchFieldName="Référence ?la ligne nombre du procéd?soumis";
					format="N";
					lengthRequirement=new ConstLengthRequirement(7);
				...
				case "G19":
					...
					frenchFieldName="Code additionnel de procéd?";
					format="N";
					lengthRequirement=new ConstLengthRequirement(5);
					break;
				case "G20":
					fieldName="Eligible Amount for the Additional Procedure";
					frenchFieldName="Quantit?éligible pour le procéd?additionnel";
					format="D";
					lengthRequirement=new ConstLengthRequirement(6);
					break;
				case "G21":
				...
				case "G23":
					...
					frenchFieldName="Quantit?d'avantage pour le procéd?additionnel";
					format="D";
					lengthRequirement=new ConstLengthRequirement(6);
					break;
				case "G24":
					fieldName="Explanation Note Number 1 for the Additional Procedure";
					frenchFieldName="Note d'explication numéro 1 pour le procéd?additionnel";
					format="N";
					lengthRequirement=new ConstLengthRequirement(2);
					break;
				case "G25":
					fieldName="Explanation Note Number 2 for the Additional Procedure";
					frenchFieldName="Note d'explication numéro 2 pour le procéd?additionnel";
					format="N";
					lengthRequirement=new ConstLengthRequirement(2);
					break;
				case "G26":
				...
				case "G29":
					...
					frenchFieldName="La quantit?déductible a désassign?";
					format="D";
					lengthRequirement=new ConstLengthRequirement(6);
					break;
				case "G30":
		...
		private void SetValuesUsingFieldId_v4(string pFieldId){
			...
			switch(pFieldId)
			{
				...
				case "A08":
					...
					frenchFieldName="Les matériaux ont expédi?";
				...
				case "E09"://Not in version 2.
					...
					frenchFieldName="Le prénom de l'abonn?secondaire";
					format="AE";
					lengthRequirement=new ConstLengthRequirement(15);
					break;
				...
				case "E14"://Not in version 2.
					...
					frenchFieldName="Code de la province/état de l'abonn?secondaire";
					format="A";
					lengthRequirement=new ConstLengthRequirement(2);
					valueRequirements.Add(new DiscreteValueRequirement(stateCodes));
					break;
				...
				case "F16"://Not in version 2.
					...
					frenchFieldName="Type codes de procéd?";
					format="A";
					lengthRequirement=new ConstLengthRequirement(5);
				...
				case "F32"://Not in version 2.
					...
					frenchFieldName="Quantit?prévue de paiement";
					format="D";
					lengthRequirement=new ConstLengthWhenOtherFieldHasValue("F25","1",6);
					break;
				...
				case "F34"://Not in version 2.
					...
					frenchFieldName="Code # 1 de procéd?de laboratoire";
					format="A/N";
					lengthRequirement=new ConstLengthRequirement(5);
					break;
				case "F35"://Not in version 2.
					fieldName="Lab Procedure Code # 2";
					frenchFieldName="Code # 2 de procéd?de laboratoire";
					format="A/N";
					lengthRequirement=new ConstLengthRequirement(5);
					break;
				case "F36"://Not in version 2.
					fieldName="Lab Procedure Fee # 2";
					frenchFieldName="Honoraires # 2 de procéd?de laboratoire";
					format="D";
					lengthRequirement=new ConstLengthRequirement(6);
					break;
				...
				case "G02":
					...
					frenchFieldName="Quantit?éligible pour le code #2 de procéd?de laboratoire";
					format="D";
					lengthRequirement=new ConstLengthRequirement(6);
					break;
				case "G03":
				...
				case "G43"://Not in version 2.
					...
					frenchFieldName="Quantit?éligible pour le code # 1 de procéd?de laboratoire";
					format="D";
					lengthRequirement=new ConstLengthRequirement(6);
					break;
				case "G44"://Not in version 2.
					fieldName="Eligible Lab Amount for the Additional Procedure";
					frenchFieldName="Quantit?éligible de laboratoire pour le procéd?additionnel";
					format="D";
					lengthRequirement=new ConstLengthRequirement(6);
					break;
				...
				case "G56"://Not in version 2.
					...
					frenchFieldName="Quantit?déductible pour le code # 1 de procéd?de laboratoire";
					format="D";
					lengthRequirement=new ConstLengthRequirement(5);
					break;
				case "G57"://Not in version 2.
					fieldName="Eligible Percentage for Lab Procedure # 1";
					frenchFieldName="Pourcentage éligible pour le procéd?# 1 de laboratoire";
					format="N";
					lengthRequirement=new ConstLengthRequirement(3);
					break;
				case "G58"://Not in version 2.
					fieldName="Benefit Amount for Lab Procedure Code #1";
					frenchFieldName="Quantit?d'avantage pour le code #1 de procéd?de laboratoire";
					format="D";
					lengthRequirement=new ConstLengthRequirement(6);
					break;
				case "G59"://Not in version 2.
					fieldName="Deductible Amount for Lab Procedure Code # 2";
					frenchFieldName="Quantit?déductible pour le code # 2 de procéd?de laboratoire";
					format="D";
					lengthRequirement=new ConstLengthRequirement(5);
					break;
				case "G60"://Not in version 2.
					fieldName="Eligible Percentage for Lab Procedure Code # 2";
					frenchFieldName="Pourcentage éligible pour le code # 2 de procéd?de laboratoire";
					format="N";
					lengthRequirement=new ConstLengthRequirement(3);
					break;
				case "G61"://Not in version 2.
					fieldName="Benefit Amount for Lab Procedure Code # 2";
					frenchFieldName="Bénéficier la quantit?pour le code # 2 de procéd?de laboratoire";
					format="D";
					lengthRequirement=new ConstLengthRequirement(6);
					break;
