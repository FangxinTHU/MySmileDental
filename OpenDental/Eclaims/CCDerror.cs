	...
	class CCDerror {
		...
		private static string MessageFr4(int errorCode){
			switch(errorCode){
				...
				case 7:
					return "Numéro du dentiste attribu?par l'ADC absent ou invalide";
				case 8:
					return "Numéro du cabinet attribu?par l'ADC absent ou invalide";
				case 9:
				...
				case 36:
					return "Date ?laquelle l'acte a ét?exécut?absente ou invalide";
				case 37:
				...
				case 44:
					return "Longueur du message indiquée non identique ?longueur du message reçu";
				case 45:
				...
				case 54:
					return "Numéro du titulaire sur Refus non conforme ?demande originale";
				case 55:
					return "Annulation ne concerne pas transaction du jour";
				case 56:
					return "Code de spécialit?du dentiste non conforme au dossier";
				case 57:
				...
				case 64:
					return "Dentiste ayant adress?(référ? patient absent ou invalide";
				case 65:
				...
				case 74:
					return "Date ?laquelle l'acte a ét?exécut?est une date ultérieure";
				case 75:
					return "Date ?laquelle l'acte a ét?exécut?est au-del?d'un an";
				case 76:
				...
				case 90:
					return "Réponse absente ou invalide : S'agit-il de la mise en bouche initiale ?la mandibule ?";
				case 91:
				...
				case 93:
					return "Matériau de la prothèse ?la mandibule absent ou invalide";
				case 94:
				...
				case 103:
					return "Code de la personne ?charge (première assurance) absent ou invalide";
				case 104:
				...
				case 121:
					return "Détail des prestations (première assurance) modifi? différent de l’original";
				case 122:
