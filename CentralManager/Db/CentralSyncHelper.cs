...
namespace CentralManager {
	public static class CentralSyncHelper {
		...
		public static void SyncAll(List<CentralConnection> listConns) {
			SyncAll(listConns,false,false);
		}

		///<summary>Called from the interface to sync just users, usergroups and permissions.</summary>
		public static void SyncUsers(List<CentralConnection> listConns) {
			SyncAll(listConns,true,false);
		}

		///<summary>Called from the interface to sync just security lock settings.</summary>
		public static void SyncLocks(List<CentralConnection> listConns) {
			SyncAll(listConns,false,true);
		}
		...
		private static void SyncAll(List<CentralConnection> listConns,bool isSyncUsers,bool isSyncLocks) {
