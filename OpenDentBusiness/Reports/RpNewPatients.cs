...
namespace OpenDentBusiness {
	public class RpNewPatients {
		...
		public static DataTable GetNewPatients(DateTime dateFrom,DateTime dateTo,List<long> listProvNums,bool includeAddress,bool excludeNoProd) {
			...
			query+=" FROM "
				...
				+"WHERE patient.PriProv IN ("+String.Join(",",listProvNums)+") ";
